...
def table_extraction_artifact_from_discovery_get(
    *, brand_input: BrandInput, chart_path: Path, result_dir: Path, source_discovery: SourceDiscovery
) -> TableExtractionArtifact:
    """Return an empty artifact-backed draft for Codex-owned extraction.
    ...
    Returns:
        Draft table extraction artifact that must be completed by Codex in real runs.
    """
    _ = brand_input
