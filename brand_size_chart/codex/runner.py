...
from brand_size_chart.codex.schema import codex_output_schema_get
...
class CodexStageRunner:
    ...
    def __init__(self, artifact_writer: JsonArtifactWriter | None = None) -> None:
